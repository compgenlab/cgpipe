...
The tool annotates anything it can't safely convert with a `# cgpipe-convert:`
...
- **[Language Syntax](03-Language_Syntax.md)** · **[Build Targets](05-Build_Targets.md)** — the cgpipe forms `convert` targets.

Reference → [language-spec.md §15.3](language-spec.md#153-cgpipe-convert--migrate-an-older-script).
