...
A cgpipe pipeline describes work; a **runner** carries it out. You choose the runner
...
When one target's output is another's input, cgpipe submits them in order and passes
