...
// the binary at build time. Each is written in cgpipe body syntax: %-prefixed lines
// are cgpipe control flow, other lines are emitted with ${…} substitution. They read
...
// `cgpipe template <name>` can print it as a starting point for customization.
